...
parseData.load(dataURL,{dateFormat, xVar, yVar, sizeVar}).then(({ seriesNames, xValueExtent, yValueExtent, sizeExtent, data, plotData, annotations, }) => { // eslint-disable-line
    // identify groups
